...
install_minio(){
  ...
  wget -P /tmp/ https://dl.min.io/server/minio/release/linux-arm64/minio_20221212192727.0.0_arm64.deb
  wget -P /tmp/ https://dl.min.io/client/mc/release/linux-arm64/mcli_20221213002328.0.0_arm64.deb
  # 2. Install both packages
  dpkg -i /tmp/minio_20221212192727.0.0_arm64.deb
  dpkg -i /tmp/mcli_20221213002328.0.0_arm64.deb
  # 3. Remove the packages
  rm /tmp/minio_20221212192727.0.0_arm64.deb /tmp/mcli_20221213002328.0.0_arm64.deb
