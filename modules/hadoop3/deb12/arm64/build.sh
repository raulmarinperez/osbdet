...
HADOOP_BINARY_URL=https://dlcdn.apache.org/hadoop/common/hadoop-3.3.6/hadoop-3.3.6-aarch64.tar.gz
HADOOP_TGZ_FILE=hadoop-3.3.6-aarch64.tar.gz
...
configfilessetup(){
  ...
  sed -i '/^# export JAVA_HOME/ s:.*:export JAVA_HOME=/usr/lib/jvm/temurin-11-jdk-arm64\nexport HADOOP_HOME=/opt/hadoop3\n:' \
