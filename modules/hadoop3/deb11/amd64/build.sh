...
HADOOP_BINARY_URL=https://archive.apache.org/dist/hadoop/common/hadoop-3.3.2/hadoop-3.3.2.tar.gz
HADOOP_TGZ_FILE=hadoop-3.3.2.tar.gz
HADOOP_DEFAULT_DIR=hadoop-3.3.2
