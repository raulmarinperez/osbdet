...
export default function KafkaBox() {
    return (
        ...
        <Link href="/kafka">
          ...
          <img alt="gallery" className="absolute inset-0 w-full h-full object-cover object-center" src="/images/kafka_box_bg.png"/>
          <OSBDETServiceStatus service_id="kafka"/>
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-90">
            <h2 className="tracking-widest text-sm title-font font-medium text-indigo-500 mb-1">Kafka 3.3.1</h2>
