...
export default function MariaDBBox() {
    return (
        ...
        <Link href="/mariadb">
          ...
          <img alt="gallery" className="absolute inset-0 w-full h-full object-cover object-center" src="/images/mariadb_box_bg.png"/>
          <OSBDETServiceStatus service_id="mariadb"/>
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-90">
            <h2 className="tracking-widest text-sm title-font font-medium text-indigo-500 mb-1">MariaDB 10.5.18</h2>
